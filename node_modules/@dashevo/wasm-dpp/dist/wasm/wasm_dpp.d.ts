...
*/
  createIdentityCreditWithdrawalTransition(identity_id: any, amount: bigint, core_fee_per_byte: number, pooling: number, output_script: Uint8Array, identity_nonce: bigint): IdentityCreditWithdrawalTransition;
/**
* @param {Identity} identity
* @param {any} recipient_id
* @param {bigint} amount
...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0bff720b62654d96: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __wbindgen_free: (a: number, b: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__hb0bccdcbffed3262: (a: number, b: number, c: number, d: number) => void;
}
