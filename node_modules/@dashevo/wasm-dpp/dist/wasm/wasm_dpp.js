...
* @returns {any}
*/function generateDocumentId(contract_id,owner_id,document_type,entropy){try{const retptr=wasm.__wbindgen_add_to_stack_pointer(-16);const ptr0=passStringToWasm0(document_type,wasm.__wbindgen_malloc,wasm.__wbindgen_realloc);const len0=WASM_VECTOR_LEN;const ptr1=passArray8ToWasm0(entropy,wasm.__wbindgen_malloc);const len1=WASM_VECTOR_LEN;wasm.generateDocumentId(retptr,addBorrowedObject(contract_id),addBorrowedObject(owner_id),ptr0,len0,ptr1,len1);var r0=getInt32Memory0()[retptr/4+0];var r1=getInt32Memory0()[retptr/4+1];var r2=getInt32Memory0()[retptr/4+2];if(r2){throw takeObject(r1);}return takeObject(r0);}finally{wasm.__wbindgen_add_to_stack_pointer(16);heap[stack_pointer++]=undefined;heap[stack_pointer++]=undefined;}}function handleError(f,args){try{return f.apply(this,args);}catch(e){wasm.__wbindgen_exn_store(addHeapObject(e));}}function passArray32ToWasm0(arg,malloc){const ptr=malloc(arg.length*4)>>>0;getUint32Memory0().set(arg,ptr/4);WASM_VECTOR_LEN=arg.length;return ptr;}/**
* @param {Uint8Array} bytes
* @returns {any}
*/function deserializeConsensusError(bytes){try{const retptr=wasm.__wbindgen_add_to_stack_pointer(-16);const ptr0=passArray8ToWasm0(bytes,wasm.__wbindgen_malloc);const len0=WASM_VECTOR_LEN;wasm.deserializeConsensusError(retptr,ptr0,len0);var r0=getInt32Memory0()[retptr/4+0];var r1=getInt32Memory0()[retptr/4+1];var r2=getInt32Memory0()[retptr/4+2];if(r2){throw takeObject(r1);}return takeObject(r0);}finally{wasm.__wbindgen_add_to_stack_pointer(16);}}function __wbg_adapter_1565(arg0,arg1,arg2,arg3){wasm.wasm_bindgen__convert__closures__invoke2_mut__hb0bccdcbffed3262(arg0,arg1,addHeapObject(arg2),addHeapObject(arg3));}/**
...
*/exports.DocumentContestNotJoinableError=DocumentContestNotJoinableError;class DocumentCreateTransition{__destroy_into_raw(){const ptr=this.__wbg_ptr;this.__wbg_ptr=0;return ptr;}free(){const ptr=this.__destroy_into_raw();wasm.__wbg_documentcreatetransition_free(ptr);}/**
    * @returns {bigint}
...
*/exports.DocumentTypeUpdateError=DocumentTypeUpdateError;class DocumentsBatchTransition{static __wrap(ptr){ptr=ptr>>>0;const obj=Object.create(DocumentsBatchTransition.prototype);obj.__wbg_ptr=ptr;return obj;}__destroy_into_raw(){const ptr=this.__wbg_ptr;this.__wbg_ptr=0;return ptr;}free(){const ptr=this.__destroy_into_raw();wasm.__wbg_documentsbatchtransition_free(ptr);}/**
    ...
    * @returns {Array<any>}
    */getKeySecurityLevelRequirement(){const ret=wasm.documentsbatchtransition_getKeySecurityLevelRequirement(this.__wbg_ptr);return takeObject(ret);}/**
    * @returns {Uint8Array}
...
*/exports.IdentityCreditTransferTransition=IdentityCreditTransferTransition;class IdentityCreditWithdrawalTransition{static __wrap(ptr){ptr=ptr>>>0;const obj=Object.create(IdentityCreditWithdrawalTransition.prototype);obj.__wbg_ptr=ptr;return obj;}__destroy_into_raw(){const ptr=this.__wbg_ptr;this.__wbg_ptr=0;return ptr;}free(){const ptr=this.__destroy_into_raw();wasm.__wbg_identitycreditwithdrawaltransition_free(ptr);}/**
    ...
    */setOutputScript(output_script){const ptr0=passArray8ToWasm0(output_script,wasm.__wbindgen_malloc);const len0=WASM_VECTOR_LEN;wasm.identitycreditwithdrawaltransition_setOutputScript(this.__wbg_ptr,ptr0,len0);}/**
    * @returns {bigint}
...
*/exports.IdentityFacade=IdentityFacade;class IdentityFactory{static __wrap(ptr){ptr=ptr>>>0;const obj=Object.create(IdentityFactory.prototype);obj.__wbg_ptr=ptr;return obj;}__destroy_into_raw(){const ptr=this.__wbg_ptr;this.__wbg_ptr=0;return ptr;}free(){const ptr=this.__destroy_into_raw();wasm.__wbg_identityfactory_free(ptr);}/**
    ...
    * @param {bigint} identity_nonce
    * @returns {IdentityCreditWithdrawalTransition}
    */createIdentityCreditWithdrawalTransition(identity_id,amount,core_fee_per_byte,pooling,output_script,identity_nonce){try{const retptr=wasm.__wbindgen_add_to_stack_pointer(-16);const ptr0=passArray8ToWasm0(output_script,wasm.__wbindgen_malloc);const len0=WASM_VECTOR_LEN;wasm.identityfactory_createIdentityCreditWithdrawalTransition(retptr,this.__wbg_ptr,addBorrowedObject(identity_id),amount,core_fee_per_byte,pooling,ptr0,len0,identity_nonce);var r0=getInt32Memory0()[retptr/4+0];var r1=getInt32Memory0()[retptr/4+1];var r2=getInt32Memory0()[retptr/4+2];if(r2){throw takeObject(r1);}return IdentityCreditWithdrawalTransition.__wrap(r0);}finally{wasm.__wbindgen_add_to_stack_pointer(16);heap[stack_pointer++]=undefined;}}/**
    * @param {Identity} identity
    * @param {bigint} identity_nonce
    * @param {any} public_keys
    * @returns {IdentityUpdateTransition}
...
*/exports.MissingStateTransitionTypeError=MissingStateTransitionTypeError;class NoDocumentsSuppliedError{static __wrap(ptr){ptr=ptr>>>0;const obj=Object.create(NoDocumentsSuppliedError.prototype);obj.__wbg_ptr=ptr;return obj;}__destroy_into_raw(){const ptr=this.__wbg_ptr;this.__wbg_ptr=0;return ptr;}free(){const ptr=this.__destroy_into_raw();wasm.__wbg_nodocumentssuppliederror_free(ptr);}/**
    */constructor(){const ret=wasm.nodocumentssuppliederror_new();return NoDocumentsSuppliedError.__wrap(ret);}}/**
*/exports.NoDocumentsSuppliedError=NoDocumentsSuppliedError;class NonConsensusErrorWasm{__destroy_into_raw(){const ptr=this.__wbg_ptr;this.__wbg_ptr=0;return ptr;}free(){const ptr=this.__destroy_into_raw();wasm.__wbg_nonconsensuserrorwasm_free(ptr);}}/**
...
*/exports.VotePollNotFoundError=VotePollNotFoundError;class WrongPublicKeyPurposeError{static __wrap(ptr){ptr=ptr>>>0;const obj=Object.create(WrongPublicKeyPurposeError.prototype);obj.__wbg_ptr=ptr;return obj;}__destroy_into_raw(){const ptr=this.__wbg_ptr;this.__wbg_ptr=0;return ptr;}free(){const ptr=this.__destroy_into_raw();wasm.__wbg_wrongpublickeypurposeerror_free(ptr);}/**
    * @returns {number}
